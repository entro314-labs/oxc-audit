# @entro314labs/oxlint-audit-plugins
...
{
  "jsPlugins": [
    "./node_modules/@entro314labs/oxlint-audit-plugins/src/data-layer/index.ts",
    "./node_modules/@entro314labs/oxlint-audit-plugins/src/next-react/index.ts"
  ],
  "rules": {
...
oxlint -c node_modules/@entro314labs/oxlint-audit-plugins/oxlintrc.audit.json --type-aware .   # needs a tsconfig
oxlint -c node_modules/@entro314labs/oxlint-audit-plugins/oxlintrc.audit.json --fix .
```
